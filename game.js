var Game = function (pCanvasID) {
    ...
    addEventListener("assetsLoaded", function(e) {
      this.factoringTrainer.showGame()
    }.bind(this))
...
Game.prototype.init = function() {
  this.factoringTrainer = new FactoringTrainer(this.STAGE_WIDTH, this.STAGE_HEIGHT, this.stage);
  this.factoringTrainer.init()
}
...
Game.prototype.update = function (pEvent) {
    ...
    if (this.factoringTrainer) {
      this.factoringTrainer.update();
    }
